...
public class BankAccountIds {
    ...
    public static final CqlIdentifier JUNIOR_ACCOUNTS = CqlIdentifier.fromCql("junior_accounts");
    public static final CqlIdentifier SAVING_ACCOUNTS = CqlIdentifier.fromCql("saving_accounts");
    public static final CqlIdentifier STANDARD_ACCOUNTS = CqlIdentifier.fromCql("standard_accounts");
